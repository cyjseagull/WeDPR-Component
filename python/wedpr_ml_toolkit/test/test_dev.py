...
from wedpr_ml_toolkit.toolkit import DatasetToolkit
...
dataset1 = DatasetToolkit(ctx, values=df, agency=agency1, is_label_holder=True)
dataset1.storage_client = None
# './milestone2\\sgd\\flyhuang1\\share\\d-101'
dataset1.save_values(path='d-101')

# hdfs_path
dataset2 = DatasetToolkit(
    ctx, dataset_path='/user/ppc/milestone2/webank/flyhuang/d-9606695119693829', agency=agency2)
